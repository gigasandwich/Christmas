                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="girl" placeholder="girl" name="girl" value="1" min="0">
                            <label for="girl">Girl</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="boy" placeholder="boy" name="boy" value="1" min="0">
